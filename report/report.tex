...
a plane fields. I will use OpenAI Gym (\cite{1606.01540}) as interface to the environment
...
Roboschool\footnote{\href{https://github.com/openai/roboschool}
  {https://github.com/openai/roboschool}} which propose
few environments among the one I will use, RoboschoolHumanoid-v1.\\
I am planning to use Reinforcemen
t Learning to tackle this task with the
...
action-value function. It is a function which returns the value of an action
$a$ from a state $s$ following a
policy $\mu$. It is defined like this:
